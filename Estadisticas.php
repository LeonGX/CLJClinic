...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Ingreso de pacientes por género</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-women"></i> Mujeres
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-men"></i> Hombres
                                        </span>
                        ...
                        <div class="col-xl-7 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Ingreso de pacientes por tipo de sangre</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                        </a>
                                ...
                                <div class="card-body">
                                    <div class="chart-pie pt-4 pb-2">
                                        <canvas id="blood-chart"></canvas>
                                    </div>
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-apos"></i> A+
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-aneg"></i> A-
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-opos"></i> O+
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-oneg"></i> O-
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-bpos"></i> B+
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-bneg"></i> B-
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-abpos"></i> AB+
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-abneg"></i> AB-
                                        </span>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ingreso de pacientes por edad</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
    ...
    <script src="js/charts/chart-ages.js"></script>
    <script src="js/charts/chart-gender.js"></script>
    <script src="js/charts/chart-blood.js"></script>
